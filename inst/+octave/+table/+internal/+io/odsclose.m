...
function [ ods ] = odsclose (ods, varargs)
  ...
  if (nargout < 1)
    warning ("odsclose: return argument missing - ods invocation not reset.\n");
  endif
