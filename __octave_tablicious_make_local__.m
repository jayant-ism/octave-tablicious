...
function __octave_tablicious_make_local__
  %__OCTAVE_TABLICIOUS_MAKE_LOCAL__ Build the octfiles for this repo
  %
  % Call this function if you are working with a local copy of this repo instead
  % of installing it as a package.
  d = dir;
  if ~ismember('__octave_tablicious_make_local__.m', {d.name})
